...
# initialize a matrix containing the coordinates of each triangle's 
# barycenter
...
# Remove the sea points to obtain the barrier ones.
normal = unlist(normal)
barrier.triangles = setdiff(1:tl, normal)

# (this obj will be used just for plotting)
...
local.make.quantile.table = function(stat, barr, quantile.words){
  ...
  # Fill the quantiles informations
  for(i in 1:3){
